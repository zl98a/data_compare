...
def get_dict_wih_same_key(new_list1, list2):
    i = 0
    for dict2 in list2:
        if dict2['年度'] == new_list1[0] and dict2['企业名称'] == new_list1[1]:
                return dict2
...
if __name__ == '__main__':
    my_excel_file_path = '../../../resource/enterprise_credit.xlsx'
    my_sheet_name = '江苏'
    list1 = read_excel_into_list(my_excel_file_path, my_sheet_name)
    my_json_file_path = '../../../resource/ads_year_enterprise_credit.json'
